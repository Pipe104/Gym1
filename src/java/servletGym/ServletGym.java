...
import logic.rutina.RutinaMantener;
...
public class ServletGym extends HttpServlet {
    ...
    public static RutinaIn ani;
    public static void asignarRutina(RutinaIn a){
        a.hacerRutinaL();
        a.hacerRutinaM();
        a.hacerRutinaW();
        a.hacerRutinaJ();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(request.getParameter("objetivo")){
            case "Subir" ->{
                RutinaSubir rSubir = new RutinaSubir();  
                asignarRutina(rSubir); 
            }
            
            case "Bajar" ->{
                RutinaBajar rBajar = new RutinaBajar();
                asignarRutina(rBajar);
            }
            
            case "Mantenerse" ->{
                RutinaMantener rMantener = new RutinaMantener();
                asignarRutina(rMantener);
            }
        }
                    ...
                    out.println("<main>");
                        ...
                        out.println("</div>");
                            ...
                            out.println("<div class=flex-item>");
                                out.println("<h3>DIA 1:</h3>");
                                out.println("<br>");
                                out.println("<p>" + ani.hacerRutinaL() + "</p>");
                            out.println("</div>");
                            out.println("<div class=flex-item>");
                                out.println("<h3>DIA 2:</h3>");
                                out.println("<br>");
                                out.println("<p>" + ani.hacerRutinaM() + "</p>");
                            out.println("</div>");
                            out.println("<div class=flex-item>");
                                out.println("<h3>DIA 3:</h3>");
                                out.println("<br>");
                                out.println("<p>" + ani.hacerRutinaW() + "</p>");
                            out.println("</div>");
                            out.println("<div class=flex-item>");
                                out.println("<h3>DIA 4:</h3>");
                                out.println("<br>");
                                out.println("<p>" + ani.hacerRutinaJ() + "</p>");
                            out.println("</div>");
                            out.println("<div class=flex-item>");
                                out.println("<h3>DIA 5:</h3>");
                                out.println("<br>");
                                out.println("<p>" + ani.hacerRutinaV() + "</p>");
                            out.println("</div>");
                            out.println("<div class=flex-item>");
                                out.println("<h3>DIA 6:</h3>");
                                out.println("<br>");
                                out.println("<p>" + ani.hacerRutinaS() + "</p>");
                            out.println("</div>");
                        out.println("</div>");
                    out.println("</main>");
                out.println("</body>");
